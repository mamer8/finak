...
GetServicesModel getServicesModelFromJson(String str) => GetServicesModel.fromJson(json.decode(str));

String getServicesModelToJson(GetServicesModel data) => json.encode(data.toJson());
